...
namespace osmium {
    ...
    namespace area {
        ...
        class FilteringMultipolygonManager : public osmium::relations::RelationsManager<FilteringMultipolygonManager<TAssembler>, false, true, false> {
        ...
        public:
            ...
            explicit FilteringMultipolygonManager(Assembler&& assembler_config, Filter&& filter, Box&& box)
            ...
            void complete_relation(const osmium::Relation& relation) {
                ...
                if(std::none_of(ways.begin(), ways.end(), [&](const osmium::Way* way) {return boost::geometry::intersects(m_box, m_factory.envelope(*way));}))
                    return;
